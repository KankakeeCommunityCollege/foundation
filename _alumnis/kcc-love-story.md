...
{% markdown %}
  ...
  **What did the two of you do for fun/dates?**
  ...
  <div class="text-center">
    <img class="img-fluid" src="../../uploads/story-img_baseball-field.jpg" alt="Scott & Taylor at the Cavaliers baseball field">
  </div>
  <br>
  <hr>

  <div class="text-center">
    <img class="float-md-end img-fluid" style="width: 300px; margin-bottom: 1rem; margin-left: 1rem;" src="../../uploads/story-img_gym.jpg" alt="Scott & Taylor posing in the George H. Ryan Activities Center">
  </div>
  ...
  **After KCC:**
  ...
  <br>
  <div class="text-center">
    <img class="img-fluid" src="../../uploads/story-img_cavaliers.jpg" alt="Scott & Taylor at the Cavaliers baseball field">
  </div>
  <br>
  <hr>
  {% endmarkdown %}
