...
const openMessage = `<p class="mb-4">
  ...
  <div style="max-width: 800px;" class="alert alert-info mx-auto mb-5 text-left">
    <p class="mb-2">
      ...
      Scholarship recipients must be enrolled at KCC for the 2026-27 academic year to receive award.
    </p>
    <p class="mb-0 text-center">
      <strong>Need Help?</strong> Contact Katie Henry: 
      <a href="tel:+18158028287">815-802-8287</a> or <a href=""mailto:khenry@kcc.edu>khenry@kcc.edu</a>
    </p>
  </div>`;
